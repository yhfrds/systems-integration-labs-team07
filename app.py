...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'dev-secret-key-change-me'   # change for production
...
def product_new():
    # For the lab: product creation has no admin guard. In real app add auth/roles.
...
# Simple route to change status (demo only; normally admin-only)


@app.route('/order/<int:order_id>/status', methods=['POST'])
def change_status(order_id):
    # For demo: no auth checking. In a real app, restrict to admins.
